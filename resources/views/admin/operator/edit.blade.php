...
<div class="row m-t-25 justify-content-center">
    <div class="col-lg-8">
        <div class="card shadow-lg border-0 rounded-lg">
            ...
            <div class="card-body">
                <form action="{{ route('admin.master-operator.update', $operator->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               id="nama_operator"
                               name="nama_operator"
                               value="{{ old('nama_operator', $namaOperator) }}"
                               required>
                        @error('nama_operator')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('is_available') is-invalid @enderror"
                                ...
                                name="is_available"
                                required>
                            <option value="1" {{ $operator->is_available ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ !$operator->is_available ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('is_available')
                            <div class="invalid-feedback">
                                {{ $message }}
