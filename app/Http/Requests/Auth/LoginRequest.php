...
class LoginRequest extends FormRequest
{
     ...
     *
     * The input_type is validated to determine whether the user is logging in with their email or username.
     * The input is then merged with the request data so that it can be validated.
     */
